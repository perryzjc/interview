...
PO 需要代表**所有[[利益相关者管理|利益相关者]]（包括用户、客户、业务方等）**的声音，并确保 [[Scrum]] 团队的工作与[[基础概念/产品愿景|产品愿景]]和[[产品战略与规划/产品战略|业务目标]]保持一致。

*注意：在实践中，产品经理 (Product Manager) 常常会承担 [[Scrum]] 团队中产品负责人的角色，但两者的职责范围和侧重点可能略有不同。PM 可能更关注长期的[[产品战略与规划/产品战略|产品战略]]、[[市场定位|市场定位]]和业务增长，而 PO 更聚焦于具体的 [[Sprint]] 交付和 [[产品待办列表]] 管理。然而，在很多公司，这两个角色是合一的。*
...
1.  **制定和清晰地沟通[[开发流程/产品目标|产品目标 (Product Goal)]]**:
    ...
    *   确保 [[Scrum]] 团队和[[利益相关者管理|利益相关者]]都理解产品目标。
...
3.  **对[[产品待办列表项]]进行排序 (Ordering Product Backlog Items)**:
    *   根据[[价值主张|用户价值]]、业务优先级、[[技术相关/技术依赖|依赖关系]]、[[技术相关/风险管理|风险]]、[[开发流程/工作量估算|工作量]]等因素，对[[产品待办列表项]]进行排序。
    *   确保[[开发团队 (Development Team)]]始终在开发最高价值的功能。这是 PO **最核心**的职责之一。常用的排序方法参见[[功能优先级排序|功能优先级排序]]。
4.  **确保[[产品待办列表]]是透明、可见和可理解的 (Ensuring Transparency, Visibility, and Understanding)**:
    *   [[产品待办列表]]应该是动态的、对所有[[利益相关者管理|利益相关者]]可见的。
...
*   **[[核心技能/决策能力|决策能力]]**: 能够在复杂和不确定的情况下，基于[[价值主张|价值]]和[[数据分析与实验/数据驱动决策|数据]]做出艰难的优先级决策。
*   **[[沟通技巧|沟通与协作能力]]**: 能够清晰地与[[开发团队 (Development Team)]]、[[Scrum Master]]、[[利益相关者管理|利益相关者]]等进行有效沟通，建立良好关系。
*   **[[核心技能/影响力|影响力与谈判能力]]**: 能够在没有直接管理权的情况下，说服他人，平衡各方需求。
*   **[[敏捷开发|敏捷思维]]**: 理解并践行敏捷价值观和原则。
