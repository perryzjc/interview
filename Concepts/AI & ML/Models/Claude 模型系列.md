...
与 [[GPT 模型系列|GPT]] 类似，Claude 模型也是**[[开源 vs 闭源模型|闭源]]**的，主要通过 **[[API (应用程序接口)|API]]** 提供服务。
...
*   **Claude 3 系列**: 2024 年初发布，是 Anthropic 当前的旗舰系列，包含三个不同规模和能力等级的模型：
    ...
    *   **Claude 3 Opus**: **能力最强**的模型，在复杂推理、数学、代码生成和多语言任务上表现顶尖，接近或在某些基准上超过 [[GPT 模型系列|GPT-4]]。支持[[多模态]]能力（图像理解）。
